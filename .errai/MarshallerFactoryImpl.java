...
@Dependent public class MarshallerFactoryImpl implements MarshallerFactory {
  ...
  private Marshaller<Response> org_company_firestorm_client_shared_Response;
  private Marshaller<MessageDeliveryFailure> org_jboss_errai_bus_client_api_base_MessageDeliveryFailure;
  private Marshaller<HelloMessage> org_company_firestorm_client_shared_HelloMessage;
  ...
  public MarshallerFactoryImpl() {
    ...
    org_company_firestorm_client_shared_Response = new Marshaller<Response>() {
      ...
      public Response demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: org.company.firestorm.client.shared.Response", t);
        }
      }
      public String marshall(Response a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"org.company.firestorm.client.shared.Response\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"org.company.firestorm.client.shared.Response\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("org.company.firestorm.client.shared.Response", org_company_firestorm_client_shared_Response);
    ...
    org_company_firestorm_client_shared_HelloMessage = new Marshaller<HelloMessage>() {
      ...
      public HelloMessage demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: org.company.firestorm.client.shared.HelloMessage", t);
        }
      }
      public String marshall(HelloMessage a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"org.company.firestorm.client.shared.HelloMessage\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"org.company.firestorm.client.shared.HelloMessage\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("org.company.firestorm.client.shared.HelloMessage", org_company_firestorm_client_shared_HelloMessage);
